...
export default function DiscussionPage() {
  ...
  return (
    <div className="travel-bg flex flex-col" style={{ height: '100dvh', minHeight: '0' }}>
      ...
      {/* Header */}
      <header className="sticky top-0 z-40 bg-gradient-to-r from-black/20 to-black/10 backdrop-blur-xl border-b border-white/15 shadow-lg flex-shrink-0">
        <div className="max-w-2xl mx-auto px-3 sm:px-5 py-3 flex items-center justify-between gap-3">
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="font-display font-extrabold text-white text-base leading-none tracking-tight">Group <span className="text-teal-300">Discussion</span></h1>
              <p className="text-white/55 text-xs mt-0.5">Hi, {user?.displayName || user?.username}! 👋</p>
            </div>
          </div>
          <div className="flex items-center gap-1.5 flex-shrink-0">
            ...
            <Link href="/memories" className="flex items-center gap-1.5 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-medium text-xs px-3 py-1.5 rounded-full transition-all"><span>📸</span><span className="hidden sm:inline">Memories</span></Link>
